...
#ifndef SIOUX_SOURCE_TOOLS_HEXDUMP_H
...
/**
 * @brief returns a ascii encoded character that is printable
 *
 * If the input char is not a printable, a '.' is returned otherwise
 * the char it self.
 */
...
#endif //SIOUX_SOURCE_TOOLS_HEXDUMP_H
