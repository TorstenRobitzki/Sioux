...
namespace json {
    ...
    namespace {
        ...
        const number update_at_operation(update_at);
        const number delete_at_operation(delete_at);
        const number insert_at_operation(insert_at);
        const number delete_range_operation(delete_range);
        const number update_range_operation(update_range);
        const number edit_at_operation(edit_at);
